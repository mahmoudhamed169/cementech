          ...
          >
            ...
            <TableCell>
              <div className="flex flex-col items-center gap-0.5">
                <span className="font-medium text-gray-800">{row.driverName}</span>
            ...
            <TableCell>
              <span className={cn("px-3 py-1 rounded-full text-xs font-medium", statusStyles[row.earningStatus])}>
                {row.earningStatus}
              </span>
            </TableCell>
            <TableCell className="text-gray-500">{row.lastPayment ?? "—"}</TableCell>
