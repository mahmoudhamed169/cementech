        ...
        <DialogContent className="min-w-275 bg-white border-0 p-0 max-h-[90vh] flex flex-col">
          <DialogHeader className="px-6 py-7 shrink-0 border-b border-[#E5E7EB]">
            <DialogTitle className="font-bold text-xl flex justify-between items-center">
              ...
              <Button
                onClick={handlePrint}
                disabled={isLoading || isError || !invoiceData}
          ...
          <div className="flex-1 overflow-y-auto flex flex-col print:overflow-visible">
            {isLoading && (
...
/* ================== محتوى الفاتورة ================== */
function InvoiceContent({ invoiceData }: any) {
  return (
    <div id="request-invoice-print-area" dir="rtl">
      <section className="px-4 py-6 space-y-8 w-full">
        <InvoiceHeader
